...
output "virtual_wan" {
  ...
  value = {
    ...
    firewall_private_ip_address = try(module.vwan_with_vhub.firewall_private_ip_address["vhub-fw"], null)
    firewall_name               = try(module.vwan_with_vhub.firewall_resource_names["vhub-fw"], null)
    firewall_id                 = try(module.vwan_with_vhub.firewall_resource_ids["vhub-fw"], null)
  }
}
